...
*ElearningApi* | [**getElearningQuizCategoriesTree**](docs/ElearningApi.md#getElearningQuizCategoriesTree) | **GET** /elearning/quiz_categories | 获取elearning测试类目
*ElearningApi* | [**getElearningQuizPageList**](docs/ElearningApi.md#getElearningQuizPageList) | **GET** /elearning/quiz_categories/{categoryId}/pages | 随机获取测试分类下的单篇列表
*ElearningApi* | [**getElearningQuizSubCategories**](docs/ElearningApi.md#getElearningQuizSubCategories) | **GET** /elearning/quiz_categories/{categoryId}/subCats | 获取elearning测试类目下的单级子分类列表
*ElearningApi* | [**getElearningTrainingCategoriesTree**](docs/ElearningApi.md#getElearningTrainingCategoriesTree) | **GET** /elearning/training_categories | 获取elearning培训类目
*ElearningApi* | [**getElearningTrainingPageList**](docs/ElearningApi.md#getElearningTrainingPageList) | **GET** /elearning/training_categories/{categoryId}/pages | 分页获取培训分类下的单篇列表
*ElearningApi* | [**getElearningTrainingSubCategories**](docs/ElearningApi.md#getElearningTrainingSubCategories) | **GET** /elearning/training_categories/{categoryId}/subCats | 获取elearning培训类目下的单级子分类列表
*ElearningApi* | [**getElearningVideoDetail**](docs/ElearningApi.md#getElearningVideoDetail) | **GET** /elearning/videos/{videoId} | 获取单个视频详细信息
...
*PlayerApi* | [**getBasicPlayer**](docs/PlayerApi.md#getBasicPlayer) | **GET** /games/players/{playerId}/basic | 获得球员基础信息
...
*PlayerApi* | [**getPlayerIntroduce**](docs/PlayerApi.md#getPlayerIntroduce) | **GET** /games/players/{playerId}/introduce | 获得球员个人介绍
*PlayerApi* | [**getPlayerNationMatches**](docs/PlayerApi.md#getPlayerNationMatches) | **GET** /games/players/{playerId}/nationMatches | 获得球员比赛信息
*PlayerApi* | [**getPlayerNationRecords**](docs/PlayerApi.md#getPlayerNationRecords) | **GET** /games/players/{playerId}/nationRecords | 获得球员比赛统计信息
...
## Documentation for Models
 ...
 - [BasicPlayer](docs/BasicPlayer.md)
 ...
 - [PlayerVideo](docs/PlayerVideo.md)
 - [Post](docs/Post.md)
