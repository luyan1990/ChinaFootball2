...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("BasicPlayer".equalsIgnoreCase(className)) {
      return new TypeToken<List<BasicPlayer>>(){}.getType();
    }
    ...
    if ("PlayerVideo".equalsIgnoreCase(className)) {
      return new TypeToken<List<PlayerVideo>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("BasicPlayer".equalsIgnoreCase(className)) {
      return new TypeToken<BasicPlayer>(){}.getType();
    }
    ...
    if ("PlayerVideo".equalsIgnoreCase(className)) {
      return new TypeToken<PlayerVideo>(){}.getType();
    }
