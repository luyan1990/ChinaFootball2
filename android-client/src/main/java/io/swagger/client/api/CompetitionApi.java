...
public class CompetitionApi {
  ...
  * 赛事所有的参赛球队信息和比赛信息（赛程）
   ...
   * @return Competition
  */
  public Competition getCompetition (String key, Long competitionId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  
      // verify the required parameter 'key' is set
      if (key == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'key' when calling getCompetition",
      new ApiException(400, "Missing the required parameter 'key' when calling getCompetition"));
      }
   ...
   * 赛事所有的参赛球队信息和比赛信息（赛程）
   * 赛事所有的参赛球队信息和比赛信息（赛程）
   * @param key key   * @param competitionId 赛事的Id
  */
  public void getCompetition (String key, Long competitionId, final Response.Listener<Competition> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
