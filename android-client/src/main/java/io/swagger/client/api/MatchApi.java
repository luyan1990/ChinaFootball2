...
public class MatchApi {
  ...
  */
  public List<MatchInfo> getByCompetitionIdAndTeamId (String key, Long competitionId, Long teamId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  
      // verify the required parameter 'key' is set
      if (key == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'key' when calling getByCompetitionIdAndTeamId",
      new ApiException(400, "Missing the required parameter 'key' when calling getByCompetitionIdAndTeamId"));
      }
   ...
   * 获取赛事比赛列表,即时间轴
   * 获取赛事比赛列表
   * @param key key   * @param competitionId 赛事的Id   * @param teamId 球队id
  */
  public void getByCompetitionIdAndTeamId (String key, Long competitionId, Long teamId, final Response.Listener<List<MatchInfo>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 获得比赛信息
   ...
   * @return Match
  */
  public Match getMatch (String key, Long competitionId, Long matchId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  
      // verify the required parameter 'key' is set
      if (key == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'key' when calling getMatch",
      new ApiException(400, "Missing the required parameter 'key' when calling getMatch"));
      }
   ...
   * 获得比赛信息
   * 获得比赛信息
   * @param key key   * @param competitionId 赛事的Id   * @param matchId 比赛Id
  */
  public void getMatch (String key, Long competitionId, Long matchId, final Response.Listener<Match> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
