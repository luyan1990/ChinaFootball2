...
public class CoachApi {
  ...
  * 查看一个教练详情
   ...
   * @return Coach
  */
  public Coach getCoach (String key, Long coachId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  
      // verify the required parameter 'key' is set
      if (key == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'key' when calling getCoach",
      new ApiException(400, "Missing the required parameter 'key' when calling getCoach"));
      }
   ...
   * 查看教练详情
   * 查看一个教练详情
   * @param key key   * @param coachId 教练Id
  */
  public void getCoach (String key, Long coachId, final Response.Listener<Coach> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 查看球队分类下的所有教练
   ...
   * @return List<Coach>
  */
  public List<Coach> getCoachByTeamCategory (String key, Long teamCategoryId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  
      // verify the required parameter 'key' is set
      if (key == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'key' when calling getCoachByTeamCategory",
      new ApiException(400, "Missing the required parameter 'key' when calling getCoachByTeamCategory"));
      }
  ...
  */
  public void getCoachByTeamCategory (String key, Long teamCategoryId, final Response.Listener<List<Coach>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public List<CoachCategoryTop> getNationalCoach (String key) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  
      // verify the required parameter 'key' is set
      if (key == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'key' when calling getNationalCoach",
      new ApiException(400, "Missing the required parameter 'key' when calling getNationalCoach"));
      }
   ...
   * @param key key
  */
  public void getNationalCoach (String key, final Response.Listener<List<CoachCategoryTop>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
